...
<div id="wrapper">
	...
	<div id="side_left">
		<ul>
			<li>커뮤니티</li>
			<li><a href="../mypage/view.do">내 정보 보기</a></li>
			<li><a href="../mypage/update.do">내 정보 수정</a></li>
			<li>쪽지함</li>
			<li><a href="../message/write.do">쪽지 보내기</a></li>
			<li><a href="../message/list.do">받은 쪽지함</a></li>
			<li><a href="../message/send/list.do">보낸 쪽지함</a></li>
		</ul>
	</div>
