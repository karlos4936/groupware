...
<div id="wrapper">
	<div id="header">
		...
		<div id="nav">
			<ul>
				...
				<li><a href="../notice/list.do">커뮤니티</a></li>
				<li><a href="../message/list.do">마이페이지</a></li>
				<li><a href="../member/list.do">사원관리</a></li>
			</ul>
		</div>
	</div>
	...
	<div id="side_left">
		<ul>
			<li>기안</li>
			<li><a href="../draft/list.do">문서 작성</a></li>
			<li><a href="../schdule/list.do">내문서</a></li>
			<li>결재</li>
			<li><a href="../notice/list.do">대기 문서</a></li>
			<li><a href="../message/list.do">진행 문서</a></li>
			<li><a href="../member/list.do">완료 문서</a></li>
		</ul>
	</div>
